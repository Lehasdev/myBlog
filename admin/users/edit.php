                ...
                <div class="row  g-0 add-user">
                    <form action="edit.php" method="post">
                        ...
                        <div class="col-6">
                            ...
                            <input type="text" class="form-control" value="<?=$username?>" name="login" id="formGroupExampleInput" placeholder="введите ваш логин">
                        </div>
                        <div class="w-100"></div>
                        <div class="col-6">
                            <label for="exampleInputEmail1" class="form-label">Email</label>
                            <input type="email" readonly class="form-control" value="<?= $mail?>" name="email" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="введите ваш Email">
                        ...
                        <div class="w-100"></div>
                        <div class="col">
                            <button name="up-user" class="btn btn-primary" type="submit">Изменить пользователя</button>
                        </div>
                    </form>
                </div>
            </div>
