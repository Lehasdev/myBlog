...
<div class="container">
    <div class="row">
        ...
        <div class="post_admin col-9">
            ...
            <p class="row title-label">
                <h2>Добавление записи</h2>
            <div class="err">
                <p><?php include '../../app/helps/errorInfo.php';?></p>
            </div>
                <div class="row  g-0 add-post">
                   <form action="create.php" method="post" enctype="multipart/form-data">
                       ...
                       <div class="form-check">
                           <input name="publish" class="form-check-input" type="checkbox" value="1" id="flex-Check-Checked" checked>
                           <label class="form-check-label" for="flex-Check-Checked">Publish</label>
                       </div>
                       <div class="w-100"></div>
                        <div class="col">

                            <button class="btn btn-primary" name="add_post" type="submit">Создать запись</button>
                        </div>
                   </form>
                </div>
